                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><a href="{{route('admin.usuario.index')}}">Usuários</a></h2><h2><i class="fa fa-chevron-right mx-2"></i></h2><h2>Atualizar Usuário</h2>
                                ...
                                <div class="x_content">
                                    <form id="form_add_cliente" action="{{route('admin.usuario.update', $usuario->id)}}" method="post" novalidate>
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" value="{{ $usuario->nome }}" data-validate-words="2" name="nome" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">CPF<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="13" value="{{ $usuario->cpf }}" data-mask="000.000.000-00" name="cpf" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='date' type="date" name="nascimento"  value="{{ $usuario->nascimento }}"></div>
                                        </div>
                                        <div class="field item form-group">
